...
app_include_js = ["service_further.bundle.js","/assets/service_further/js/frappe/ui/form/controls/hello_button.js", "/assets/service_further/js/frappe/ui/form/controls/entry_doctype.js"]
